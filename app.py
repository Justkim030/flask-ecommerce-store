    ...
    with app.app_context():
        ...
        if Product.query.count() == 0:
            ...
            initial_products = {
                ...
                4: {'name': 'TP-Link Archer C6 WiFi Router', 'price': 5000, 'old_price': 6500, 'rating': 4.6, 'description': ['Dual Band', '4 Antennas', 'Gigabit Ports'], 'image': 'https://placehold.co/400x300/f4f4f4/333?text=TP-Link+Router', 'category': 'Accessories'},
                ...
                13: {'name': 'Sony WH-1000XM5 Headphones', 'price': 45000, 'old_price': 52000, 'rating': 4.9, 'description': ['Noise Cancelling', 'Wireless', '30-Hour Battery'], 'image': 'https://placehold.co/400x300/f4f4f4/333?text=Sony+Headphones', 'category': 'Accessories'},
                ...
                29: {'name': 'Mac Mini M2', 'price': 90000, 'old_price': 100000, 'rating': 4.8, 'description': ['Apple M2 Chip', '8GB RAM', '256GB SSD', 'Compact Power'], 'image': 'https://placehold.co/400x300/f4f4f4/333?text=Mac+Mini+M2', 'category': 'Desktops'},
                ...
                41: {'name': 'Corsair Vengeance i7400', 'price': 280000, 'old_price': 310000, 'rating': 4.9, 'description': ['Intel Core i7', '32GB DDR5', '2TB NVMe SSD', 'RTX 4070'], 'image': 'https://placehold.co/400x300/f4f4f4/333?text=Corsair+PC', 'category': 'Desktops'},
                ...
                45: {'name': 'Lenovo Legion Tower 5i', 'price': 175000, 'old_price': 190000, 'rating': 4.6, 'description': ['Intel Core i7', '16GB RAM', '512GB SSD + 1TB HDD'], 'image': 'https://placehold.co/400x300/f4f4f4/333?text=Lenovo+Legion', 'category': 'Desktops'},
            }
